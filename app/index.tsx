...
import { ImageBackground, StyleSheet, Text, TextInput, TouchableOpacity, Platform, View, ScrollView, KeyboardAvoidingView, Image } from "react-native";
  ...
  const handleButtonClick = () => {
    ...
    fetch("http://legacyfarmsnorthhoa.life:3001/api/v1/workspace/lfgpt/chat", {
      ...
      headers: {
        ...
        "Authorization": "Bearer HTZP9B6-W58M5A9-PAVE1CT-AAJK75C"
      },
      body: JSON.stringify({
    ...
    <ImageBackground source={require('../assets/images/gptbg.jpg')} resizeMode="cover"
      ...
      <View style={{ flex: 1 }}>
        <View style={{ flexDirection: "row" }}>
          <View style={{
            flex: 1, backgroundColor: "rgb(30,30,30)", height: 30,
        ...
        <View style={{ flex: 1, justifyContent: "center" }}>
          ...
          <GiftedChat
            ...
            onSend={newMessage => console.log(newMessage)}
        ...
        <View style={{ flexDirection: "row" }}>
          <KeyboardAvoidingView style={{
            flex: 1, marginLeft: 10, marginBottom: 20, backgroundColor: "rgb(100,100,100)",
